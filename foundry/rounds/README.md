...
Cada carpeta registra una candidata, la evidencia considerada, el veredicto, y la decisión humana. El formato y el criterio están definidos en [`../governance.md`](../governance.md).
